package com.georgen.gpt4allrest.network;

import com.georgen.gpt4allrest.model.exceptions.NetworkException;
...
public class HttpConnector implements AutoCloseable {
    ...
    public String post(String endpoint, String json) throws NetworkException {
        return post(endpoint, null, json);
    }

    public String post(String endpoint, String parameters, String json) throws NetworkException {
